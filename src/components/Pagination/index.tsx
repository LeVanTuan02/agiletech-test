      ...
      <div className={cx("pagination__left")}>
        {data!.currentPage <= data!.totalPage && data!.currentPage >= 1 ? (
          <p>
            ...
            <span>{data!.currentPage * data!.limit > data!.total ? data!.total : data!.currentPage * data!.limit}</span>{" "}
            trong <span>{data!.total}</span> kết quả
          </p>
        ) : (
          <p>
            ...
            <button
              ...
              className={`${
                index + 1 === data!.currentPage
                  ? cx("pagination__right-num-active")
                  : cx("pagination__right-num-normal")
